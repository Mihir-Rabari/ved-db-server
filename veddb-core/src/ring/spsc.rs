...
impl SpscRing {
    ...
    pub fn try_push(&self, slot: Slot) -> bool {
        ...
        unsafe {
            ...
            self.producer_index.store(producer_idx + 1, Ordering::Release);
        }
    ...
    pub fn try_pop(&self) -> Option<Slot> {
        ...
        unsafe {
            ...
            self.consumer_index.store(consumer_idx + 1, Ordering::Release);
...
impl SpscRingBuffer {
    ...
    pub fn new(capacity: u64) -> Self {
        ...
        let ring = unsafe {
            SpscRing::init(memory.as_mut_ptr(), capacity)
        };
