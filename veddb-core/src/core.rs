...
impl VedDb {
    ...
    fn handle_publish(&self, command: Command, seq: u32) -> Response {
        // Extract channel name from command.key and payload from command.value
